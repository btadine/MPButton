Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                      ...
                      Or adding new elements without breaking existing layout? Just make the touchable area bigger?
                      If you're smiling, probably you did!

                      MPButton comes to the stage to solve this issues.
                      Wraps any view that you provide adding UIControlEvents (ie. touchUpInside) and custom hit box.
                       DESC
